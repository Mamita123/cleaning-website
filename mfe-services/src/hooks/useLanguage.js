...
const translations = {
  en: {
    ...
    servicesDesc:   "From regular home cleaning to home cleaning, deep cleans, office cleaning, store cleaning, window cleaniong, store cleaning , restrant and bar and move-in/move-out — we have a professional solution for every situation.",
...
storeCleaning: "Store Cleaning",
    ...
    servicesDesc:   "Tavallisesta kotisiivouksesta syvasiivoukseen, toimistosiivous, ravintola ja baari, ikkunapesu, myymalasiivous ja muutto siivoukseen — meilla on ammattimainen ratkaisu jokaiseen tilanteeseen.",
